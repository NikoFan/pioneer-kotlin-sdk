...
- arm() - запуск двигателей
- disarm() - выключение двигателей
- ledControl() - работа с LED подсветкой
- blinkLeds() - мигание LED модуля

---
## Тестирование
Все функции и команды тестируются на модели Geoscan Pioneer Mini
Если на вашем дроне не работает какой-то компонент: #Напишите!
